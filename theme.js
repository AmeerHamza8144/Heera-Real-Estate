(() => {
  ...
  function createSocials(){const nav=document.createElement('nav');nav.className='footer-socials';nav.setAttribute('aria-label','Social media');nav.innerHTML='<a href="https://www.facebook.com/" target="_blank" rel="noopener">Facebook</a><a href="https://www.instagram.com/" target="_blank" rel="noopener">Instagram</a><a href="https://wa.me/923091496014" target="_blank" rel="noopener">WhatsApp</a>';return nav;}
